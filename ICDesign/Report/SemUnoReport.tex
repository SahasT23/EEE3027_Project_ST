...
\subsection{Lab 1 Part 1}

Explain what an NMOS and PMOS transistor is, their structure and operation. 
Discuss the I-V characteristics of both transistors, 
highlighting the differences in their operation regions (cutoff, linear, saturation). 
Include equations governing their behavior in each region.
Explain the equations for both NMOS and PMOS transistors.
...
\subsection{PMOS and NMOS I-V Characteristics (First Task - Lab 1 Part 1)}
